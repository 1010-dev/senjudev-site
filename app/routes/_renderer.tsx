  ...
  return (
    <html lang="ja">
      <head>
        ...
        <meta name="description" content="千住エリアを中心とした足立区で活動するエンジニア・デザイナー・クリエイターのためのコミュニティです。定期的な勉強会やもくもく会を開催しています。" />
        ...
        <meta property="og:description" content="千住エリアを中心とした足立区で活動するエンジニア・デザイナー・クリエイターのためのコミュニティです。" />
        ...
        <meta name="twitter:description" content="千住エリアを中心とした足立区で活動するエンジニア・デザイナー・クリエイターのためのコミュニティです。" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description: "千住エリアを中心とした足立区で活動するエンジニア・デザイナー・クリエイターのためのコミュニティ",
            foundingLocation: {
              "@type": "Place",
              name: "千住エリア",
              address: {
